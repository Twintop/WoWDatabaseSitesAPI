...
{
    [Serializable()]
    public abstract class WDSAObject : ICloneable
    {
        #region Properties
        ...
        public WowheadSiteType WowheadSite { get; set; }
        public WoWDBSiteType WoWDBSite { get; set; }
        public WoWDBItem WoWDBAPIItem { get; set; }
        public string WoWDBAPIJSON { get; set; }
        #endregion
