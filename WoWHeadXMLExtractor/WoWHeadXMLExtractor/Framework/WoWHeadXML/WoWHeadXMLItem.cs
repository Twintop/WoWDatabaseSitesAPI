    ...
    public class WoWHeadXMLItem : WoWHeadXMLObject
    {
        ...
        public int BonusArmor
        {
            get
            {
                ...
                if (this.itemJsonEquipData.armorbonus > returnValue)
                {
                    returnValue = this.itemJsonEquipData.armorbonus;
                }

                if (this.TooltipData.BonusArmor > returnValue)
                {
                    returnValue = this.TooltipData.BonusArmor;
                }
        ...
        public int Multistrike
        {
            get
            {
                ...
                if (this.itemJsonEquipData.multistrike > returnValue)
                {
                    returnValue = this.itemJsonEquipData.multistrike;
                }

                if (this.TooltipData.Multistrike > returnValue)
                {
                    returnValue = this.TooltipData.Multistrike;
                }
        ...
        public int Spirit
        {
            get
            {
                ...
                if (this.itemJsonEquipData.spi > returnValue)
                {
                    returnValue = this.itemJsonEquipData.spi;
                }

                if (this.TooltipData.Spirit > returnValue)
                {
                    returnValue = this.TooltipData.Spirit;
                }
